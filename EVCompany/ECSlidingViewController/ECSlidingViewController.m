...
- (void)addTopViewSnapshot
{
    ...
    // Add layer shadow//integrated
    
//    CALayer * mainLayer = [self.topViewSnapshot layer];
//    mainLayer.masksToBounds = NO;
//    CGPathRef pathRect = [UIBezierPath bezierPathWithRect:self.topViewSnapshot.bounds].CGPath;
//    mainLayer.shadowColor = [UIColor blackColor].CGColor;
//    mainLayer.shadowOffset = CGSizeMake(-5.0, 0.0);
//    mainLayer.shadowOpacity = 0.095f;
//    mainLayer.shadowPath = pathRect;
//    mainLayer.shadowRadius = 5.0f;
}
